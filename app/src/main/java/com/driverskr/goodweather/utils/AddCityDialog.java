...
import com.driverskr.goodweather.databinding.DialogAddCityBinding;
...
import com.driverskr.goodweather.ui.adapter.RecommendCityAdapter;
import com.driverskr.goodweather.ui.adapter.SearchCityAdapter;
...
/************************************搜索城市相关***********************************/
        ...
        binding.etSearchCity.setOnEditorActionListener((v, actionId, event) -> {
            if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                ...
                //搜索城市
                SearchCityRepository.getInstance().searchCity(searchCityResponseMutableLiveData, failed, cityName, true);
                //关闭输入法
