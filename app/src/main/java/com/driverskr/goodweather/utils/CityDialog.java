...
import com.driverskr.goodweather.databinding.DialogCityBinding;
import com.driverskr.goodweather.db.bean.Province;
import com.driverskr.goodweather.ui.adapter.AdministrativeClickCallback;
import com.driverskr.goodweather.ui.adapter.AreaAdapter;
import com.driverskr.goodweather.ui.adapter.CityAdapter;
import com.driverskr.goodweather.ui.adapter.ProvinceAdapter;
...
/**
 * 加载获取到的城市数据，然后显示出来，再点击Item是根据区域类型做不同的处理
 */
